...
- 🎯 **Category ST/MT/LT PER Seller:** سه خروجی تو یک تب:
  ...
  - 📦 **خروجی ZIP جدا برای هر فروشنده** (اختیاری): همون لیست کالای بج‌دار، ولی این‌بار تفکیک‌شده — یک اکسل به ازای هر فروشنده با نام `SellerID-SellerName.xlsx`.
...
### ۶. تب Category ST/MT/LT PER Seller (سه خروجی، یک تب)

این تب سه خروجی جدا از هم داره:
...
- **ZIP اختیاری (Tail ST/MT/LT):** یک اکسل جدا به ازای هر فروشنده از همون لیست کالای بج‌دار Category ST/MT/LT، با همون نام‌گذاری `SellerID-SellerName.xlsx`.
...
5. **تولید فایل ZIP جدا برای هر فروشنده (Tail ST/MT/LT)** — چک‌باکس اختیاری دیگر، برای همون تفکیک اما روی لیست کالای بج‌دار تب Category ST/MT/LT.
